<template>
  <div class="content">
    ...
    <h3
      ...
      v-if="auth.user.level == 'superuser' || auth.user.level == 'admin'"
    >
      <i class="fa fa-image" style="padding-right: 10px; font-size: 40px"></i
      ><strong>Galeri Program Pelatihan</strong>
    </h3>
    <div
      ...
      >
        ...
        <md-table-row slot="md-table-row" slot-scope="{ item }">
          ...
          <md-table-cell
            md-label="Caption"
            md-sort-by="caption"
            style="min-width: 300px; padding-right: 20px; text-align: justify"
          >
            {{ item.caption }}
          </md-table-cell>
...
export default {
  ...
  methods: {
    ...
    ...mapActions("gallery", ["getGalleryList", "deleteGallery"]),
    async onFetchData() {
    ...
    onDelete(id) {
      this.$confirm({
        message: `Yakin ingin menghapus data Galeri?`,
        button: {
          no: "Batal",
          yes: "Ya"
        },
