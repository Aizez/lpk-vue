<template>
  <div class="content">
    ...
    <h3
      ...
      v-if="auth.user.level == 'superuser' || auth.user.level == 'admin'"
    >
      <i class="fa fa-list-ul" style="padding-right: 10px; font-size: 40px"></i
      ><strong>List Program Pelatihan</strong>
    </h3>
    <div
    ...
    >
      ...
      >
        <a
          href="#/dashboard/list-program-create"
      ...
      >
        <md-table-row slot="md-table-row" slot-scope="{ item }">
          ...
          <md-table-cell
            md-label="Deskripsi"
            md-sort-by="deskripsi"
            style="min-width: 200px; padding-right: 20px; text-align: justify"
          >
            {{ item.desc_program }}
          </md-table-cell>
          ...
          <md-table-cell>
            ...
            >
              <i
                ...
                ><md-tooltip md-direction="bottom"
                  >Delete Program Pelatihan</md-tooltip
                ></i
              >
            </md-button>
          </md-table-cell>
...
export default {
  ...
  methods: {
    ...mapActions("program", ["getProgramList", "deleteProgram"]),
    async onFetchData() {
      await this.getProgramList();
    },
    onDelete(id) {
      this.$confirm({
        message: `Yakin ingin menghapus data Program Pelatihan?`,
        button: {
          no: "Batal",
          yes: "Ya"
        },
